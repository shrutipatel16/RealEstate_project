                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Unlock the potential of your property with our premier selling service, tailored to maximize value and streamline the process."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Elevate your rental experience with our comprehensive service, connecting landlords with quality tenants effortlessly."</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Discover your perfect property match through our dynamic listing service, offering a diverse range of real estate options tailored to your needs.
                                    "</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Navigate the complexities of legal investment seamlessly with our comprehensive service,
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Discover top-rated real estate listings for quality and excellence. Find your ideal property with ease and confidence."</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Experience top-quality real estate listings tailored for excellence. Find your perfect property effortlessly."</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Connect with experienced real estate agents for expert guidance. Find your ideal property with seasoned professionals."</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Engage in meaningful discussions on our platform to exchange insights and ideas effortlessly. 
                                Connect with like-minded individuals and experts to explore diverse perspectives and deepen your understanding."</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Easily review files on our platform with streamlined efficiency. Access and assess documents seamlessly for a hassle-free experience."</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>"Acquire assets seamlessly through our platform's streamlined process.
                                 Discover and secure your desired acquisitions with ease."</p>
                        </div>
                    </div>
                </div>
            </div>
